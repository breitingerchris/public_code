		...
		try:
			...
			if 'cyka blyat' in r.text:
				...
				headers = {
					...
					'Referer': 'https://storefront.sweettooth.io/purchase/101075?accountId=2891&channelId=3039&ct='+caid
				}
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"twitter_share","channel_id":3039}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"facebook_share","channel_id":3039}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"instagram_follow","channel_id":3039}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"twitter_follow","channel_id":3039}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"facebook_like","channel_id":3039}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.get(
							'https://storefront.sweettooth.io/api/v1/points_products?account_id=2891&include=promo',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.put(
							'https://storefront.sweettooth.io/api/v1/new_points_products/15303/purchase',
