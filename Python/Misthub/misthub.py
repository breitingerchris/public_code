		...
		try:
			...
			if 'Log Out' in r.text:
				...
				headers = {
					...
					'Referer': 'https://storefront.sweettooth.io/purchase/101075?accountId=10928&channelId=11063&ct='+caid
				}
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"twitter_share","channel_id":11063}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"facebook_share","channel_id":11063}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"instagram_follow","channel_id":11063}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"twitter_follow","channel_id":11063}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.post(
							'https://storefront.sweettooth.io/api/v1/activities',
							data='{"activity":{"activity_type":"facebook_like","channel_id":11063}}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				...
				r = s.get(
							'https://storefront.sweettooth.io/api/v1/points_products?account_id=10928&include=promo',
							verify=False,
							proxies=prozy,
							headers=headers
				)
				r = s.put(
							'https://storefront.sweettooth.io/api/v1/points_products/101075/purchase',
							data='{"customer_id":"'+caid+'","points_to_spend":310}',
							verify=False,
							proxies=prozy,
							headers=headers
				)
